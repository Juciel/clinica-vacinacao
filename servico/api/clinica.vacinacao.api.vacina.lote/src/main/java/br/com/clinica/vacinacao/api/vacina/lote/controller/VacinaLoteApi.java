...
@Api(value = "API de Lotes de Vacinas", produces = MediaType.APPLICATION_JSON_VALUE)
public interface VacinaLoteApi {
    ...
    @GetMapping(value = "/api/v1/clinica/vacinacao/vacina/lotes", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/api/v1/clinica/vacinacao/vacina/lote", produces = MediaType.APPLICATION_JSON_VALUE)
